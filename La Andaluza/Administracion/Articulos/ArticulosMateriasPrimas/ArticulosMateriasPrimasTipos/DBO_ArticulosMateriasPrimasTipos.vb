Public Class DBO_ArticulosMateriasPrimasTipos

   Private m_MateriaPrimaTipoID As Int32
   Private m_Descripcion As String
   Private m_Liquido As String
   ...
   Public Property MateriaPrimaTipoID() As Int32
       Get
