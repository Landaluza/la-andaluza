Public Class DBO_ArticulosEnvasadoHistorico
    ...
    Public Property CodigoQS() As Int32
        Get
            Return if(isdbnull(m_CodigoQS.value), Nothing, m_CodigoQS.value)
        End Get
        Set(ByVal value As Int32)
    ...
    Public Property Separadores() As Int32
        Get
            Return if(isdbnull(m_Separadores.value), Nothing, m_Separadores.value)
        End Get
        Set(ByVal value As Int32)
    ...
    Public Property CajasPalet() As Int32
        Get
            Return if(isdbnull(m_CajasPalet.value), Nothing, m_CajasPalet.value)
        End Get
        Set(ByVal value As Int32)
    ...
    Public Property Genericas() As String
        Get
            Return if(isdbnull(m_Genericas.value), String.empty, m_Genericas.value)
        End Get
        Set(ByVal value As String)
    ...
    Public Property Particulares() As String
        Get
            Return if(isdbnull(m_Particulares.value), String.empty, m_Particulares.value)
        End Get
        Set(ByVal value As String)
    ...
    Public Property TipoProductoID() As Int32
        Get
            Return if(isdbnull(m_TipoProductoID.value), Nothing, m_TipoProductoID.value)
        End Get
        Set(ByVal value As Int32)
    ...
    Public Property TipoCajaID() As Int32
        Get
            Return if(isdbnull(m_TipoCajaID.value), Nothing, m_TipoCajaID.value)
        End Get
        Set(ByVal value As Int32)
