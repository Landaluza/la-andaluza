...
Class spVisitasNombres1
    ...
    Public Function Select_Record(ByVal VisitaNombreID As Int32, ByRef dtb As BasesParaCompatibilidad.DataBase) As DBO_VisitasNombres1
        dtb.Conectar()
    ...
    Public Function VisitasNombres1Insert(ByVal dbo_VisitasNombres1 As DBO_VisitasNombres1, ByRef dtb As BasesParaCompatibilidad.DataBase) As Boolean
        dtb.Conectar()
    ...
    Public Function VisitasNombres1Update(ByVal newDBO_VisitasNombres1 As DBO_VisitasNombres1, ByRef dtb As BasesParaCompatibilidad.DataBase) As Boolean
        dtb.Conectar()
    ...
    Public Function VisitasNombres1Delete(ByVal VisitaNombreID As Int32, ByRef dtb As BasesParaCompatibilidad.DataBase) As Boolean
        dtb.Conectar()
    ...
    Public Sub GrabarVisitasNombres1(ByVal dbo_VisitasNombres1 As DBO_VisitasNombres1, ByRef dtb As BasesParaCompatibilidad.DataBase)
        ...
        If dbo_VisitasNombres1.VisitaNombreID = 0 Then
            VisitasNombres1Insert(dbo_VisitasNombres1, dtb)
        Else
            VisitasNombres1Update(dbo_VisitasNombres1, dtb)
        End If
    End Sub
