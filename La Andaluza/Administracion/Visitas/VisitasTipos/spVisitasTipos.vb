...
Class spVisitasTipos
    ...
    Public Function Select_Record(ByVal VisitaTipoID As Int32) As DBO_VisitasTipos
        ...
        Try
            ...
            selectCommand = new System.Data.SqlClient.SqlCommand(selectProcedure, connection)
    ...
    Public Function VisitasTiposInsert(ByVal dbo_VisitasTipos As DBO_VisitasTipos) As Boolean
        BasesParaCompatibilidad.BD.Conectar()
        Dim connection As System.Data.SqlClient.SqlConnection  = BasesParaCompatibilidad.BD.Cnx
    ...
    Public Function VisitasTiposUpdate(ByVal newDBO_VisitasTipos As DBO_VisitasTipos) As Boolean
        BasesParaCompatibilidad.BD.Conectar()
        Dim connection As System.Data.SqlClient.SqlConnection  = BasesParaCompatibilidad.BD.Cnx
    ...
    Public Function VisitasTiposDelete(ByVal VisitaTipoID As Int32) As Boolean
        BasesParaCompatibilidad.BD.Conectar()
        Dim connection As System.Data.SqlClient.SqlConnection  = BasesParaCompatibilidad.BD.Cnx
    ...
    Public Sub GrabarVisitasTipos(ByVal dbo_VisitasTipos As DBO_VisitasTipos)
        ...
        If dbo_VisitasTipos.VisitaTipoID = 0 Then
            VisitasTiposInsert(dbo_VisitasTipos)
        Else
            VisitasTiposUpdate(dbo_VisitasTipos)
        End If
    End Sub
