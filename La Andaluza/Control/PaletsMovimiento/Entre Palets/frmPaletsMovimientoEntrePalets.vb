                ...
                If DBO_PaletsMovimientoTipo.EntrePalets Then
                    If frmDestino.txtSCC.Text = "" Then
                        ...
                        If MessageBox.Show("No ha indicado palet de destino, ¿crear uno?", "Atencion", MessageBoxButtons.YesNo) = Windows.Forms.DialogResult.No Then
                            ...
                            Return False
                        Else
                            Dim dEnvasado As Envasado.DBO_Envasados
                            Dim dFormatoOrigen As Envasado.DBO_FormatosEnvasados
                            Dim spEnvasado As New Envasado.spEnvasados
                            Dim spFormato As New Envasado.spFormatosEnvasados
                            ...
                            Try
                                ...
                                m_PaletProducidoDestino = New Envasado.DBO_PaletsProducidos2
