...
Public Class frmPaletSCC
    ...
    Private spPaletsContenidos2 As Envasado.spPaletsContenidos2

    Public Sub New()
        InitializeComponent()
        spPaletsProducidos2 = New Envasado.spPaletsProducidos2
        spPaletsContenidos2 = New Envasado.spPaletsContenidos2
            ...
            If Not dgvMovimientos.CurrentRow Is Nothing Then
                If Me.dgvMovimientos.CurrentRow.Cells("TipoMovimiento").Value = "Envasar" Then
                    ...
                    If resp = DialogResult.Yes Then
                        ...
                        Dim dboPaletsProducidos As Envasado.DBO_PaletsProducidos = sppp.Select_RecordBySSCC(Me.dgvMovimientos.CurrentRow.Cells("SCC").Value, dtb)
