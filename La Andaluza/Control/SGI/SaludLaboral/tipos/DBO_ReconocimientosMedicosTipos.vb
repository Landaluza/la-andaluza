Public Class DBO_ReconocimientosMedicosTipos
inherits BasesParaCompatibilidad.DataBussines
   ...
   Public Sub New()
       MyBase.New()
       m_Id = New BasesParaCompatibilidad.DataBussinesParameter("@ReconocimientoMedicoTipoID","ReconocimientoMedicoTipoID")
