Public Class Ctl_Provincias
    ...
    Public Sub Añadir_provincias_para_combo(ByRef comboProvincias As ComboBox, ByVal id_pais As Integer, ByRef dtb As BasesParaCompatibilidad.DataBase)
        ...
        Try
            Me.sp_provincias.cargar_ComboBox(comboProvincias, id_pais, dtb)
