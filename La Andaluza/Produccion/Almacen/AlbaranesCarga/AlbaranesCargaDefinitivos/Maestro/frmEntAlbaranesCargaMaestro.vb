    ...
    Private Sub btnNuevoCamion_Click(sender As Object, e As EventArgs) Handles btnNuevoCamion.Click
        Try
            ...
            If spCAmion.Grabar(dboCamion, dtb) Then
                MessageBox.Show("Se han añadido los datos correctamente", "", MessageBoxButtons.OK, MessageBoxIcon.Information)
            Else
                MessageBox.Show("No se pudo añadir el camion, revise los datos", "", MessageBoxButtons.OK, MessageBoxIcon.Information)
            End If
        Catch ex As Exception
