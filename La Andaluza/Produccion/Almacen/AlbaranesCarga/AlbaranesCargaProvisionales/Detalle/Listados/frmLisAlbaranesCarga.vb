...
Public Class frmLisAlbaranesCarga
    ...
    Private Sub frmLisAlbaranesCarga_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        cboReferencia.mam_DataSource(dtb.Consultar("exec TiposFormatosSelectCbo1"), True, "Todas")
        cboClientes.mam_DataSource(dtb.Consultar("exec ClientesCbo"), True, "Todos")
        cboLugaresEntrega.mam_DataSource(dtb.Consultar("exec LugaresEntregasCbo"), True, "Todos")
    End Sub
