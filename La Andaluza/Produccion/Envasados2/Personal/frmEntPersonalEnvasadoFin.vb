...
Public Class frmEntPersonalEnvasadoFin
    ...
    Private Sub setValores()
        ...
        dtEmpleados = spEmlpeados.devolver_Empleados_actuales_del_formato(Me.dbo.id_formatoEnvasado)
        ...
        Dim d As DBO_FormatosEnvasados = sp.Select_Record(Me.dbo.id_formatoEnvasado)
