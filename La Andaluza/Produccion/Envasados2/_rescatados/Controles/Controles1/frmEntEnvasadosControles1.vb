Public Class frmEntEnvasadosControles1
    ...
    Public Sub New(ByVal modo As String, ByRef EnvasadosControles1 As DBO_EnvasadosControles1)
        MyBase.New(modo)
        InitializeComponent()
        spEnvasadosControles1 = New spEnvasadosControles1
    ...
    Public Shadows Sub Guardar(ByRef m_DBO_EnvasadosControles1 As DBO_EnvasadosControles1)
        GetValores()
        spEnvasadosControles1.GrabarEnvasadosControles1(m_DBO_EnvasadosControles1, dtb)
        Me.Close()
    End Sub
End Class
