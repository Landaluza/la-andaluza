Public Class DBO_EnvasadosControles7
    ...
    Private m_Roscador5 As Boolean
    Private m_Roscador6 As Boolean
    ...
    Public Property Roscador5() As Boolean
        Get
            Return m_Roscador5
        End Get
        Set(ByVal value As Boolean)
    ...
    Public Property Roscador6() As Boolean
        Get
            Return m_Roscador6
        End Get
        Set(ByVal value As Boolean)
