...
Class spEnvasadosControles7
    ...
    Public Sub New()
        MyBase.New("[dbo].[EnvasadosControles7Select]", "[dbo].[EnvasadosControles7Insert]", "[dbo].[EnvasadosControles7Update]", _
                   "[dbo].[EnvasadosControles7Delete]", "EnvasadosControles7SelectDgv", "EnvasadosControles7SelectDgvByEnvasadoControlID")
    End Sub
    Public Function SelectByEnvasadoControlID(ByVal EnvasadoControlID As Int32) As DBO_EnvasadosControles7
        BasesParaCompatibilidad.BD.Conectar()
        Dim DBO_EnvasadosControles1 As New DBO_EnvasadosControles7
        Dim connection As System.Data.SqlClient.SqlConnection = BasesParaCompatibilidad.BD.Cnx
        Dim selectProcedure As String = "[dbo].[EnvasadosControles7SelectDgvByEnvasadoControlID]"
    ...
    Public Function Select_Record(ByVal EnvasadoControl1ID As Int32) As DBO_EnvasadosControles7
        BasesParaCompatibilidad.BD.Conectar()
        Dim DBO_EnvasadosControles1 As New DBO_EnvasadosControles7
        Dim connection As System.Data.SqlClient.SqlConnection = BasesParaCompatibilidad.BD.Cnx
        Dim selectProcedure As String = "[dbo].[EnvasadosControles7Select]"
        Dim selectCommand As New System.Data.SqlClient.SqlCommand(selectProcedure, connection)
        selectCommand.CommandType = CommandType.StoredProcedure
    ...
    Public Function EnvasadosControles1Insert(ByVal dbo_EnvasadosControles1 As DBO_EnvasadosControles7) As Boolean
        BasesParaCompatibilidad.BD.Conectar()
        Dim connection As System.Data.SqlClient.SqlConnection = BasesParaCompatibilidad.BD.Cnx
        Dim insertProcedure As String = "[dbo].[EnvasadosControles7Insert]"
    ...
    Public Function EnvasadosControles1Update(ByVal newDBO_EnvasadosControles1 As DBO_EnvasadosControles7) As Boolean
        BasesParaCompatibilidad.BD.Conectar()
        Dim connection As System.Data.SqlClient.SqlConnection = BasesParaCompatibilidad.BD.Cnx
        Dim updateProcedure As String = "[dbo].[EnvasadosControles7Update]"
