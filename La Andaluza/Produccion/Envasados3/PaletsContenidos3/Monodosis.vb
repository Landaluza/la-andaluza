...
Public Class Monodosis
    ...
    Public Sub añadirMovimientoEncajado(ByVal hora As TimeSpan, _
    ...
    Public Function realizarDiferencia(ByVal fecha As Date, ByVal hora As TimeSpan, ByVal scc As Integer, ByRef dtb As BasesParaCompatibilidad.DataBase) As Boolean
        Dim textNotificar As String = ""
        'Dim fecha As String = DateTime.Now.Day & "/" & DateTime.Now.Month & "/" & DateTime.Now.Year
        Dim linea As String
    ...
    Public Function moverNC(ByVal fecha As Date, ByVal hora As TimeSpan, ByRef dtb As BasesParaCompatibilidad.DataBase, ByVal scc As Integer, ByVal cantidad As Integer) As Boolean
        Dim textNotificar As String = ""
        ' Dim fecha As String = DateTime.Now.Day & "/" & DateTime.Now.Month & "/" & DateTime.Now.Year
        Dim linea As String
        Dim spPalet As New spPaletsProducidos
